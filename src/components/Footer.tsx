...
export const Footer =()=>{
    return(
    <footer className="w-full h-[500px] flex items-center flex-wrap">
        <aside className="w-full md:w-2/4 px-10 pt-10 md:pt-40">
        ...
        <nav className="w-full md:w-2/5 px-10 pt-10 md:pt-40">
