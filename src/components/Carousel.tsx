...
export const ImageCarousel =()=>{
    ...
    return(
        <Carousel pauseOnHover className="w-full h-[300px]">
            {workData.map((work: IWork) =>
                <Link 
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-0 group-hover:h-1/3 bg-orange-500 text-center transition-[height] overflow-hidden">
