...
export const About =()=>{
    return(
        <section id="about" className="flex md:items-center items-start w-full h-screen bg-about bg-center bg-cover px-1 sm:px-10 md:px-20 pt-10">
            <article className="w-full md:w-[500px]  p-4 bg-gray-400 rounded-3xl backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
                ...
                <p className="text-sm sm:text-base md:text-lg tracking-wide pt-4">
