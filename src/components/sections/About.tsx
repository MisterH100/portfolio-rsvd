...
export const About =()=>{
    return(
        <section id="about" className="flex items-center w-full h-full md:h-screen bg-about bg-center bg-cover px-1 sm:px-10 md:px-20 pt-10 py-40 md:py-0">
            <article className="w-full md:w-[500px] p-4 bg-gray-400 rounded-3xl backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
                ...
                <div>
                    <motion.p 
                        ...
                        viewport={{once:true}}
                        className="text-base md:text-lg tracking-wide pt-4">
